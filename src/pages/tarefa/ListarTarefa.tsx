...
import { FormControl, FormHelperText, Grid, Input } from '@mui/material';
...
const ListarTarefa = () => {
  ...
  // função para filtar lista

  const handleSearchTask = (task) => {
    const filteredTasks = tarefas.filter((e) => e.tituloTarefa.toLowerCase() == task.toLowerCase());
    ...
    <Card>
        ...
        <Grid item xs={6}>
            <FormControl fullWidth>
              <Input id="tarefa_titulo" aria-describedby="tarefa_titulo_helper_text"  onChange={e => { handleSearchTask(e.target.value) }} />
